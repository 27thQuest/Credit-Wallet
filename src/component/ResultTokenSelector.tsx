...
interface TokenSelectorProps {
  onClose: () => void;
  onSelectReceiveToken: (token: Currency) => void;
}

export const ResultTokenSelector: React.FC<TokenSelectorProps> = ({ onClose, onSelectReceiveToken }) => {
  return (
          ...
          <div className="inner">
            <div className="select-token-wrap">
              <div className="currency-list-wrap">
                <div className="lists">
                  <button type="button" className="currency-label" onClick={() => { onSelectReceiveToken("CTC") }}>
                  ...
                  <button type="button" className="currency-label" onClick={() => { onSelectReceiveToken("USDC") }}>
                  ...
                  <button type="button" className="currency-label" onClick={() => { onSelectReceiveToken("USDT") }}>
                  ...
                  <button type="button" className="currency-label" onClick={() => { onSelectReceiveToken("WCTC") }}>
